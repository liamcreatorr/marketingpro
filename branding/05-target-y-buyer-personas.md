...
| Frase al descargar | *«Quiero dejar de morirme en los 5K.»* |
| Frase al cancelar | *«Ya entendí cómo armar la rutina, la sigo por mi cuenta.»* |
| Objeción | *«¿Para qué pago si mi coach del box me puede armar algo?»* |
| Paga | Sí, sin dudar. Ya paga mensualidad de box: la comparación le es favorable. |
| Dónde vive | Instagram, el grupo de WhatsApp del box, el box mismo. |
| Quién influye | Su coach y sus compañeros de box. |

**Por qué Kenia le sirve:** es el enemigo B en persona — *«tú no eres corredor»*. Y necesita exactamente el diferencial 1: un plan que entienda que ya viene reventado del box de ayer.

**Riesgo:** es el más propenso a cancelar por «ya aprendí». La retención depende de que el plan siga cambiando con él (perfil adaptativo), no de que le enseñe una rutina.
...
**El de conversión más rápida.** Tiene fecha y tiene miedo.

| | |
|---|---|
| Ocupación | Profesional independiente o empleado con ingreso en divisas. |
| Semana | Corre 3-4 veces. Ya tiene reloj — Garmin, Amazfit o similar. |
| Motivación | Rendimiento puro. Tiene un tiempo objetivo en la cabeza. |
| Constancia | Obsesivo con el dato. Mira ritmo, zonas, progresión. |
| Disparador | **Se inscribió en un 10K o un 21K y la carrera es en 12 semanas.** |
| Frase al descargar | *«Tengo el 21K en tres meses y no sé si voy bien.»* |
| Frase al cancelar | *«Ya corrí la carrera.»* |
| Objeción | *«Esto lo tengo gratis en Garmin Coach.»* |
| Paga | Sí y rápido. Es el candidato real de ELITE. |
| Dónde vive | Strava, grupos de running de la ciudad, Instagram. |
| Quién influye | Otros corredores del grupo, sus propios datos. |

**Por qué Kenia le sirve:** diferencial 5, prevención de lesiones. Su miedo real no es correr lento: es llegar roto a la carrera. Y diferencial 2 —explicar el porqué— porque este perfil quiere entender, no obedecer.

**Riesgo:** churn estacional brutal. Se va cuando corre la carrera. La retención pasa por engancharlo al siguiente objetivo antes de que cruce la meta del primero.

---

## 4 · Patricia, 42 — «la que vuelve»

**La que mejor paga por la promesa central.**

| | |
|---|---|
| Ocupación | Profesional consolidada. Ingreso estable en dólares. |
| Semana | Ordenada pero con poco margen. |
| Motivación | Salud y disciplina. Quiere sostener, no destacar. |
| Constancia | Corría antes. Paró por lesión, embarazo, mudanza o agotamiento. |
| Disparador | Se siente lista para volver — y tiene miedo de repetir la lesión. |
| Frase al descargar | *«Quiero volver a correr sin lesionarme otra vez.»* |
| Frase al cancelar | *«Me volví a lesionar.»* ← el peor churn posible para esta marca |
| Objeción | *«¿Una app va a saber cómo está mi rodilla?»* |
| Paga | Sí, y es la menos sensible al precio de las cuatro. Paga por seguridad. |
| Dónde vive | Instagram, grupos de corredoras, su fisioterapeuta. |
| Quién influye | Su fisio o su médico. |

**Por qué Kenia le sirve:** es la única de las cuatro para quien la **prevención es el producto**, no una función. Los diferenciales 1, 3 y 5 le hablan directamente.

**Riesgo de marca:** si se lesiona usando Kenia, la marca falla en su promesa más literal. Hay que ser conservadores en el copy de prevención: *«reducimos el riesgo»*, nunca *«no te vas a lesionar»*. Es el valor 4 aplicado.
