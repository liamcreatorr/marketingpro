# Bloque 00 — Síntesis · Kenia

> Estado: **cerrado con 4 huecos**. Fuente: respuestas de Liam y Alonzo (sesión 03-09) + `Marca Oficial Kenia Sport.pdf`.
...
- **Lanzamiento:** octubre.
- **Mercado inicial:** Venezuela (Caracas). Aspiración: LatAm hispanohablante.
- **Comunidad semilla:** el círculo del fundador en su box de CrossFit — gente que ya declaró que va a pagar.
...
Viene del **país Kenia** y del gentilicio *kenianos*, por su peso en el mundo del running. Decisión cerrada; el dueño tendría que aprobar cualquier cambio y no se espera que lo haga.
...
> «La sensación de que tienes un entrenador 100 % para ti, que no te hace sentir mal, que te entiende y se adapta a tu medida, pero te lleva al objetivo **en running**.»

**Borde (futuro):** nutrición, HIIT, movilidad, fuerza, natación. No son el producto hoy y no deben comunicarse como si lo fueran.

### Los cinco diferenciales, en orden de fuerza

1. **Decide contigo cada día.** Antes de entrenar pregunta sueño, molestias, piernas, estrés y tiempo disponible; y entonces decide: entrenar según lo previsto, bajar intensidad, o descansar **sin que eso cuente como fallar**. El plan se adapta *antes*, no después de analizar resultados.
2. **Explica el porqué de cada sesión.** «Hoy 6 × 3 min a ritmo intenso porque tu objetivo es el 10K; como ayer dormiste poco, quitamos una repetición.» La mayoría de apps dicen qué hacer; Kenia enseña por qué.
3. **Gemelo digital del corredor.** Perfil que aprende cómo respondes a la carga, cuánto tardas en recuperar, qué te hace mejorar, cuándo te sobrecargas, qué días te saltas. Dos personas con el mismo objetivo terminan con planes distintos.
...
> No. Pero hoy nuestro corazón es claramente el running. Kenia no nace para hacer de todo: nace para resolver que la mayoría de corredores siguen planes que no se adaptan a su vida. Empezamos por running porque es donde queremos construir la mejor experiencia posible y demostrar el modelo adaptativo. La tecnología no está limitada al running: a futuro entran fuerza, movilidad, nutrición, ciclismo o natación. Nuestra visión es más grande que el running; nuestra obsesión inicial es dominarlo.
