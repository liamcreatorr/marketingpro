...
### El arquetipo en tres situaciones
...
## Si Kenia fuera una persona

Tiene entre 35 y 40 años y ya no tiene nada que demostrar. Corrió lo suficiente como para saber que la disciplina no es gritar más fuerte. Viste funcional y sin logos gritones. Habla claro, sin adornos y sin muletillas motivacionales. Se levanta temprano y no lo publica. Escucha más de lo que habla. Cuando te ve mal, no te grita: **te pregunta**.

## Cinco adjetivos

**Atento · Claro · Firme · Honesto · Cercano**

## Cinco que definitivamente no
...
Domina **competencia** (confiable, inteligente, competente), apoyada en **sinceridad** (honesta, cercana, real).

**No es rudeza** — que es exactamente la dimensión que proyecta el manual visual actual.

## Comportamiento en cuatro momentos

| | |
|---|---|
| **Un viernes a las 11 de la noche** | No publica nada. No es una marca de fiesta ni de «los débiles duermen». |
| **Un lunes a las 6 de la mañana** | Ya te dijo qué toca hoy y por qué, ajustado a cómo dormiste. |
| **Cuando comete un error** (caída, cobro mal hecho, plan mal calculado) | Lo dice sin drama, explica qué pasó y qué hizo para arreglarlo. No regala meses como disculpa automática: eso es comprar perdón. |
| **Cuando alguien la compara con Strava** | No se defiende ni ataca. Explica que hacen cosas distintas. |

## La frase de posicionamiento

> **Si Strava es el muro donde publicas lo que hiciste, Kenia es la voz que decide contigo lo que vas a hacer.**

---

# 3 · Tono de voz · ejes Nielsen Norman

```
Divertido    1 ── 2 ── 3 ──[4]── 5   Serio
Casual       1 ──[2]── 3 ── 4 ── 5   Formal
Irreverente  1 ── 2 ── 3 ──[4]── 5   Respetuoso
Entusiasta   1 ── 2 ──[3]── 4 ── 5   Neutro
```
...
| **Casual ↔ Formal** | **2 — casual** | Tuteo venezolano. Habla como el compañero de entreno que además sabe. Nada de «estimado usuario». |
| **Irreverente ↔ Respetuoso** | **4 — respetuosa** | No se burla del usuario ni de la competencia ni de quien va lento. El respeto es coherente con el enemigo B: no puedes legitimar a alguien y burlarte de otro igual. |
| **Entusiasta ↔ Neutro** | **3 — equilibrio** | Entusiasta con el **proceso** («llevas seis semanas seguidas»), neutra con los **datos** («ritmo medio 5:53/km»). Nunca eufórica: la euforia envejece mal cuando el usuario falla. |

## Tratamiento

**Tú.** Mercado inicial Venezuela. Nunca *vos*, nunca *usted*. En expansión regional se revisa; el *tú* funciona en casi toda Latinoamérica.

## Tono por momento

El tono no es uno solo: cambia según lo que le está pasando a la persona.

| Momento | Tono | Ejemplo de calibración |
|---|---|---|
| **Onboarding** | Cálido, concreto, sin promesas grandes | «Antes de armar tu plan necesito saber tres cosas. Toma dos minutos.» |
...
| Prohibido | Por qué |
|---|---|
| «sin excusas», «excusas» | Es el enemigo declarado, literal |
...
«hoy toca» · «cómo amaneciste» · «tu semana» · «ajustamos» · «descansar también entrena» · «por qué» · «vamos a…» · «tu plan te esperó»

---

# 4 · La pregunta difícil: cómo exigir sin culpabilizar

Es la que rompe a casi todas las marcas de fitness. La respuesta de Kenia:

> **La exigencia se le pone al plan, nunca a la persona.**

El plan es duro cuando toca serlo —series exigentes, semanas de carga, objetivos que cuestan—. Lo que nunca se juzga es al que lo sigue. La dureza vive en el contenido del entrenamiento; la comprensión, en la voz que lo entrega.

Y la exigencia se **gana explicando**: quien entiende por qué le toca una sesión dura la hace. Quien solo recibe la orden, la negocia.

Traducido a tres reglas operativas:
...
> Antes: *«Donde termina tu excusa, empieza tu carrera.»*
> Calibrado: *«Tu semana cambia. Tu plan también.»*

La segunda dice lo mismo que el producto hace, no lo contrario.
